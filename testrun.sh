...
echo "hostname is $hostname, continue? "
echo "locale is $locale, continue? "
echo "timezone is $timezone, continue? "
echo "language is $lang, continue? "
echo -n "username is $username, continue? "
read con7
